...
BatteryFaultList::BatteryFaultList()
    : faultLabels_(
{
    FaultLabel(INTERNAL_COMMUNICATION_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(INTERNAL_CONVERSION_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(WEAK_CELL_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(LOW_CELL_VOLTAGE_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(OPEN_WIRING_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CURRENT_SENSOR_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(PACK_VOLTAGE_SENSOR, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(VOLTAGE_REDUNDANCY_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(THERMISTOR_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CANBUS_COMMUNICATIONS_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(HIGH_VOLTAGE_ISOLATION_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(POWER_SUPPLY_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CHARGE_LIMIT_ENFORCEMENT_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(DISCHARGE_LIMIT_ENFORCEMENT_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CHARGER_SAFETY_RELAY_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(INTERNAL_THERMISTOR_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(INTERNAL_LOGIC_FAULT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(WEAK_PACK_FAULT, FaultPriorities::MEDIUM_PRIORITY, false, true)
    , FaultLabel(INTERNAL_MEMORY_FAULT, FaultPriorities::MEDIUM_PRIORITY, false, true)
    , FaultLabel(FAN_MONITOR_FAULT, FaultPriorities::LOW_PRIORITY, false, true)
    , FaultLabel(ALWAYS_ON_SUPPLY_FAULT, FaultPriorities::LOW_PRIORITY, false, true)
    , FaultLabel(DCL_REDUCED_DUE_TO_TEMPERATURE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(DCL_REDUCED_DUE_TO_LOW_CELL_VOLTAGE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(DCL_REDUCED_DUE_TO_LOW_PACK_VOLTAGE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(DCL_AND_CCL_REDUCED_DUE_TO_VOLTAGE_FAILSAFE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(DCL_AND_CCL_REDUCED_DUE_TO_COMMUNICATION_FAILSAFE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_HIGH_SOC, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_TEMPERATURE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_HIGH_CELL_VOLTAGE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_HIGH_PACK_VOLTAGE, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_CHARGER_LATCH, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_ALTERNATE_CURRENT_LIMIT, FaultPriorities::HIGH_PRIORITY, false, true)
    , FaultLabel(DCL_REDUCED_DUE_TO_LOW_SOC, FaultPriorities::MEDIUM_PRIORITY, false, true)
    , FaultLabel(DCL_REDUCED_DUE_TO_HIGH_CELL_RESISTANCE, FaultPriorities::LOW_PRIORITY, false, true)
    , FaultLabel(CCL_REDUCED_DUE_TO_HIGH_CELL_RESISTANCE, FaultPriorities::LOW_PRIORITY, false, true)
})
, currentFault_(0)
{
}
