...
FaultView::FaultView(MotorFaultsPresenter& motorFaultsPresenter,
    ...
    , cclReducedDueToAlternateCurrentLimit_ ("CCL Reduced Alternate Current")
    , cclReducedDueToChargerLatch_ ("CCL Reduced Charger Latch")
    , cclReducedDueToHighCellResistance_ ("CCL Reduced High Cell Resistance")
    , cclReducedDueToHighCellVoltage_ ("CCL Reduced High Cell Voltage")
    , cclReducedDueToHighPackVoltage_ ("CCL Reduced High Pack Voltage")
    , cclReducedDueToHighSoc_ ("CCL Reduced High SOC")
    , cclReducedDueToTemperature_ ("CCL Reduced Temperature")
    , dclandCclReducedDueToCommunicationFailsafe_ ("DCL and CCL Reduced Communication Fail Safe")
    , dclandCclReducedDueToVoltageFailsafe_ ("DCL and CCL Reduced Voltage Fail Safe")
    , dclReducedDueToHighCellResistance_ ("DCL Reduced High Cell Resistance")
    , dclReducedDueToLowCellVoltage_ ("DCL Reduced Low Cell Voltage")
    , dclReducedDueToLowPackVoltage_ ("DCL Reduced Low Pack Voltage")
    , dclReducedDueToLowSoc_ ("DCL Reduced Low SOC")
    , dclReducedDueToTemperature_ ("DCL Reduced Temperature")
    , labelBCount_ (0)
{
