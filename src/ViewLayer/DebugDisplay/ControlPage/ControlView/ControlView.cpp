...
//                             border: 1px solid white;";
    ...
    const QString LOW_BEAMS_OFF = "image: url(:/Resources/LowHeadlightIndicatorOff.png);";

    const QString HIGH_BEAMS_ON = "image: url(:/Resources/HighHeadlightIndicator.png);";

    const QString HIGH_BEAMS_OFF = "image: url(:/Resources/HighHeadlightIndicatorOff.png);";
...
ControlView::ControlView(DriverControlsPresenter& driverControlsPresenter, LightsPresenter& lightsPresenter,
                         I_ControlUi& ui)
